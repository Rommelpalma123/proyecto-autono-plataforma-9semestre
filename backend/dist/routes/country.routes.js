...
router.post('/pais', country_controller_1.paisController.nuevoPais);
router.get('/pais', country_controller_1.paisController.mostrarPaises);
router.get('/pais/:idPais', country_controller_1.paisController.mostrarPais);
router.put('/pais/:idPais', country_controller_1.paisController.actualizarPais);
router.delete('/pais/:idPais', country_controller_1.paisController.eliminarPais);
