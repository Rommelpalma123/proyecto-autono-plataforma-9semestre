...
router.post('/registro', register_controller_1.registroController.nuevoRegistro);
router.get('/registro', register_controller_1.registroController.mostrarTodosLosRegistro);
router.get('/registro/:idRegistro', register_controller_1.registroController.mostrarRegistro);
router.put('/registro/:idRegistro', register_controller_1.registroController.actualizarRegistro);
router.delete('/registro/:idRegistro', register_controller_1.registroController.eliminarRegistro);
