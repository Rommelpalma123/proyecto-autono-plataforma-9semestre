...
router.post('/tramite', procedure_controller_1.tramiteController.nuevoTramite);
router.get('/tramite', procedure_controller_1.tramiteController.mostrarTodosLosTramite);
router.get('/tramite/:idTramite', procedure_controller_1.tramiteController.mostrarTramite);
router.put('/tramite/:idTramite', procedure_controller_1.tramiteController.actualizarTramite);
router.delete('/tramite/:idTramite', procedure_controller_1.tramiteController.eliminarTramite);
